...
public:
  ...
  global_configuration(const nlohmann::json& json,
    ...
    helper_values_.push_back_value<bool>("show_settings_window_on_startup",
                                         show_settings_window_on_startup_,
                                         false);
  ...
  const bool& get_show_settings_window_on_startup(void) const {
    return show_settings_window_on_startup_;
  }
  void set_show_settings_window_on_startup(bool value) {
    show_settings_window_on_startup_ = value;
  }
...
private:
  ...
  bool show_settings_window_on_startup_;
